...
```{r testing, echo=FALSE, warning=FALSE, message=FALSE}
col1 <- paste(field_data$name_property_owner[field_data$id==report_id], 
          field_data$street_address[field_data$id==report_id],
          field_data$phone_number[field_data$id==report_id],
          sep="<br>")
```
